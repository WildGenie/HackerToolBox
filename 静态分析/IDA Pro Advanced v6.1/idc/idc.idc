...
//    or:
//      insn_t object:
//        cs, ip, ea, itype, size, auxpref, insnpref, segpref, flags: check ua.hpp
...
void SetTargetAssembler(long asmidx);
...
success SetSegClass(long ea,string class);
...
//             if isEnum(flag) then typeid specifies
//             the enum id
//             if isCustom(flags) then typeid specified
...
#define BPTATTR_TYPE   3  // type of the breakpoint
                          // Breakpoint types:
#define  BPT_EXEC    0    // Hardware: Execute instruction
