...
.data
pinfo				PLUGIN_INFO <DUP2_PLUGIN_VERSION,"com.d2k2.checkwindowsversion","[Check Windows Version]","checkwindowsversion.d2p">
...
DUP2_ModuleDescription proc uses esi edi ebx _plugin_data:DWORD
	...
	.elseif [esi].MY_PLUGIN_DATA_STRUCTURE.wProcessorArchitecture == PROCESSOR_ARCHITECTURE_INTEL
		mov edx,chr$("x86")
	.else
		mov edx,chr$("any CPU architecture")	
	.endif
...
DialogPlugin proc uses ebx esi edi hwnd,message,wparam,lparam
	...
	.if eax==WM_INITDIALOG
		...
		mov hDROPDOWN_MATCHTYPE,eax
	        fn SendMessage,hDROPDOWN_MATCHTYPE,CB_ADDSTRING,0,"exactly"
	        fn SendMessage,hDROPDOWN_MATCHTYPE,CB_ADDSTRING,0,"minimum"
	        fn SendMessage,hDROPDOWN_MATCHTYPE,CB_ADDSTRING,0,"maximum"
