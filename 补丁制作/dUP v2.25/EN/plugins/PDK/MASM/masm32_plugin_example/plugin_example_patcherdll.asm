...
PLUGIN_Action proc uses esi edi ebx _plugin_data
	...
	fn AddMsg,"[Plugin Example]"	;first Message should be the module name
	
	fn AddMsg,"do somthing with this file:"
	...
	.if [esi].MY_PLUGIN_DATA_STRUCTURE.copy2temp == TRUE
		...
		.if eax == INVALID_FILE_ATTRIBUTES
			fn AddMsg,"...can not find the file!"
		.else
			fn AddMsg,"...copying to TEMP folder"
