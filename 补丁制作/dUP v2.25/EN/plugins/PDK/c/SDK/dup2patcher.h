...
BOOL __stdcall PLUGIN_Action(LPVOID);        // paramater: pointer to the plugindata // must return TRUE or FALSE                                                 // paramater: pointer to the plugindata // must return TRUE or FALSE
