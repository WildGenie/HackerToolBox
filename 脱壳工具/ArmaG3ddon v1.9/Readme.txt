...
EXPORTED FUNCTIONS
//////////////////////////////////////////////////////////////////////////////////////////////
function GetProcName(IRHModule : cardinal; IRAddress :Cardinal; IRProcName : PChar): Integer;stdcall;

exports GetProcName name 'GetProcName@12';
...
Input parameters:
 ...
 IRAddress - Address of buffer contaning the Virtual Address of the function from what you want to get the Function Name.
 IRProcName - Pointer to a string containing the name of a function. 

Ouptut parameters:
 Return of function is the Name of the API.


#############################################################################################
function GetProcOrdinal(IRHModule : cardinal; IRAddress :Cardinal) : Cardinal;stdcall;
...
Ouptut parameters:
 Return of function is the ordinal.


#############################################################################################
function GetProcNameAndOrdinal(IRHModule : cardinal; IRAddress :Cardinal; var IROrdinal : Cardinal; IRProcName : PChar): Integer;stdcall;

exports GetProcNameAndOrdinal name 'GetProcNameAndOrdinal@16';
...
Input parameters:
 IRHModule - Handle of a module previously loaded in memory.
 IRAddress - Address of buffer contaning the Virtual Address of the function from what you want to get the Function Name.
 IROrdinal - Address of buffer contaning the Ordinal of the function from what you want to get the Function Name.
 IRProcName - Pointer to a string containing the name of a function.
