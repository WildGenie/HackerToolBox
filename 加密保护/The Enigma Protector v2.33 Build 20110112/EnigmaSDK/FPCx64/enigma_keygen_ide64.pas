...
function KG_GenerateRegistrationKey(kg : PKeyGenParams) : dword;
function KG_GenerateRegistrationKeyA(kg : PKeyGenParamsA) : dword;
function KG_GenerateRegistrationKeyW(kg : PKeyGenParamsW) : dword;
function KG_GenerateRegistrationKeyFromProject(ProjectFile : PAnsiChar; kg : PKeyGenParams) : dword;
function KG_GenerateRegistrationKeyFromProjectA(ProjectFile : PAnsiChar; kg : PKeyGenParamsA) : dword;
function KG_GenerateRegistrationKeyFromProjectW(ProjectFile : PWideChar; kg : PKeyGenParamsW) : dword;
function KG_VerifyRegistrationInfo(kv : PKeyVerifyParams) : dword;
function KG_VerifyRegistrationInfoA(kv : PKeyVerifyParamsA) : dword;
function KG_VerifyRegistrationInfoW(kv : PKeyVerifyParamsW) : dword;
function KG_VerifyRegistrationInfoFromProject(ProjectFile : PAnsiChar; kv : PKeyVerifyParams) : dword;
function KG_VerifyRegistrationInfoFromProjectA(ProjectFile : PAnsiChar; kv : PKeyVerifyParamsA) : dword;
function KG_VerifyRegistrationInfoFromProjectW(ProjectFile : PWideChar; kv : PKeyVerifyParamsW) : dword;

implementation

const
  keygen_api_dll_name  = 'keygen64.dll';
