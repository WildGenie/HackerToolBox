...
// Protection API
__declspec(dllimport) int __stdcall EP_ProtectedStringByID( int Total, char* Left, int Len);
__declspec(dllimport) int __stdcall EP_ProtectedStringByKey( char* Key, char* Left, int Len);
// Crypt API
