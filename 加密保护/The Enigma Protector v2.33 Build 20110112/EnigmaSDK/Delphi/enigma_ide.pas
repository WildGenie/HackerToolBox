...
function EP_RegSaveKeyA( Name : PAnsiChar; Key : PAnsiChar) : boolean; stdcall;
function EP_RegSaveKeyW( Name : PWideChar; Key : PWideChar) : boolean; stdcall;
...
function EP_RegLoadKeyW( var Name : PWideChar; var Key : PWideChar) : boolean; stdcall;
function EP_RegDeleteKey : boolean; stdcall;
function EP_RegCheckKey( Name : PAnsiChar; Key : PAnsiChar) : boolean; stdcall;
function EP_RegCheckKeyA( Name : PAnsiChar; Key : PAnsiChar) : boolean; stdcall;
...
function EP_RegHardwareIDA : PAnsiChar; stdcall;
function EP_RegHardwareIDW : PWideChar; stdcall;
...
function EP_RegKeyExecutions( var Total, Left : Cardinal) : boolean; stdcall;
function EP_RegKeyExecutionsTotal : Cardinal;
function EP_RegKeyExecutionsLeft : Cardinal;
function EP_RegKeyDays( var Total, Left : Cardinal) : boolean; stdcall;
function EP_RegKeyDaysTotal : Cardinal;
function EP_RegKeyDaysLeft : Cardinal;
function EP_RegKeyRuntime( var Total, Left : Cardinal) : boolean; stdcall;
function EP_RegKeyRuntimeTotal : Cardinal;
function EP_RegKeyRuntimeLeft : Cardinal;
function EP_RegKeyGlobalTime( var Total, Left : Cardinal) : boolean; stdcall;
...
function EP_RegKeyInformation(AName, AKey : PAnsiChar; var AKeyInfo : TKeyInformation) : boolean; stdcall;
function EP_RegKeyInformationA(AName, AKey : PAnsiChar; var AKeyInfo : TKeyInformation) : boolean; stdcall;
function EP_RegKeyInformationW(AName, AKey : PWideChar; var AKeyInfo : TKeyInformation) : boolean; stdcall;
...
function EP_CheckupFindProcess(FileName, WindowText, WindowClass : PAnsiChar) : boolean; stdcall;
function EP_CheckupFindProcessA(FileName, WindowText, WindowClass : PAnsiChar) : boolean; stdcall;
function EP_CheckupFindProcessW(FileName, WindowText, WindowClass : PWideChar) : boolean; stdcall;
...
procedure EP_CryptEncryptBuffer(Buffer : pointer; Size : Cardinal; Key : PAnsiChar); stdcall; external enigma_api_dll_name name 'EP_CryptEncryptBuffer';
procedure EP_CryptEncryptBufferEx(InBuffer, OutBuffer : pointer; Size : Cardinal; Key : pointer; KeySize : Cardinal); stdcall; external enigma_api_dll_name name 'EP_CryptEncryptBufferEx';
procedure EP_CryptDecryptBuffer(Buffer : pointer; Size : Cardinal; Key : PAnsiChar); stdcall; external enigma_api_dll_name name 'EP_CryptDecryptBuffer';
procedure EP_CryptDecryptBufferEx(InBuffer, OutBuffer : pointer; Size : Cardinal; Key : pointer; KeySize : Cardinal); stdcall; external enigma_api_dll_name name 'EP_CryptDecryptBufferEx';
