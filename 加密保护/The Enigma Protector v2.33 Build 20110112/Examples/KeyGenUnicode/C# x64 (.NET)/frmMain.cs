...
namespace Test
{
	...
	public class frmMain : System.Windows.Forms.Form
	{
        ...
        private void btnGenerate_Click(object sender, System.EventArgs e)
        {
            ...
            Enigma_KeyGen_IDE64.TKeyGenParamsW kg = new Enigma_KeyGen_IDE64.TKeyGenParamsW();
            ...
            uint dwResult = Enigma_KeyGen_IDE64.KG_GenerateRegistrationKeyW(ref kg);
        ...
        private void btnGenerateFP_Click(object sender, EventArgs e)
        {
            ...
            uint dwResult = Enigma_KeyGen_IDE64.KG_GenerateRegistrationKeyFromProjectW("default.enigma", ref kg);
            if (dwResult == Enigma_KeyGen_IDE64.EP_NO_ERROR)
            {
                tbKey.Text = kg.Key;
            }
        ...
        private void btnVerify_Click(object sender, EventArgs e)
        {
            ...
            Enigma_KeyGen_IDE64.TKeyVerifyParamsW kv = new Enigma_KeyGen_IDE64.TKeyVerifyParamsW();
            ...
            // Generate reg. key
            uint dwResult = Enigma_KeyGen_IDE64.KG_VerifyRegistrationInfoW(ref kv);
        ...
        private void btnVerifyFP_Click(object sender, EventArgs e)
        {
            ...
            // Generate reg. key
            uint dwResult = Enigma_KeyGen_IDE64.KG_VerifyRegistrationInfoFromProjectW("default.enigma", ref kv);
