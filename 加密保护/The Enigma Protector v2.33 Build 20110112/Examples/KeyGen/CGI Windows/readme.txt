...
1. Place keygen.exe to cgi-bin folder of your web site
2. Enable execution permissions for keygen.exe
...
<a href="http://yoursite.com/cgi-bin/keygen.exe?Action=GenerateKeyFromProject&FileName=default.enigma&RegName=Vladimir%20Sukhov&Hyphens=1&Expiration=01012030&Sections=1010001001001001">Click here to generate registration key from project file</a>
