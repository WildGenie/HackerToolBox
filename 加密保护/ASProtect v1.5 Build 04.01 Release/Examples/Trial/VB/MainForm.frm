...
Dim RegInfo As String
    ...
    MsgBox "This example shows the work in trial mode' Chr(13) + Chr(10) +
           "Don't  forget to protect the example in order to see the work of ASProtect API", vbInformation, "Information"
    ...
    Else
       ...
       lRegInfo.Caption = "Unregistered version! You have" + Str(apiGetTrialDays) + " day(s) left !"
