...
function WDC_FirstRunTrial(pHardId:PChar; var TrialExpInfo: TTrialExpInfo):Boolean;cdecl;
function WDC_FirstRunLicense(pHardId:PChar; RegName:PChar; RegCompany:PChar; RegCustom:PChar; var RegExpInfo: TRegExpInfo):Boolean;cdecl;
...
function WDC_FirstRunTrial(pHardId:PChar; var TrialExpInfo: TTrialExpInfo):Boolean;
begin

  Form1 := TForm1.Create(application);
  Form1.LabelStatus.Caption := 'WDC_TrialFirstRun function called!';
  Form1.labelStatus.Width := Form1.Width;
  Form1.TrialInfoGroup.Visible := True;
  Form1.GroupBox2.Visible := False;
  Form1.labelAppStatus.Visible := False;
  Form1.labelExtStatus.Visible := False;
...
function WDC_FirstRunLicense(pHardId:PChar; RegName:PChar; RegCompany:PChar; RegCustom:PChar; var RegExpInfo: TRegExpInfo):Boolean;
begin

  Form1 := TForm1.Create(application);
  Form1.LabelStatus.Caption := 'WDC_FirstRunLicense function called!';
  Form1.labelStatus.Width := Form1.Width;
  Form1.TrialInfoGroup.Visible := True;
