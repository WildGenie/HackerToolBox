...
#define LICENSE_MANIPULATED     4
 ...
 extern "C" _stdcall __declspec(dllimport) bool DemoExpirationDate(SYSTEMTIME* SisTime);
 extern "C" _stdcall __declspec(dllimport) bool IsDemoDateExpired();
 ...
 extern "C" bool _stdcall  DemoExpirationDate(SYSTEMTIME* SysTime);
 extern "C" bool _stdcall  IsDemoDateExpired();
