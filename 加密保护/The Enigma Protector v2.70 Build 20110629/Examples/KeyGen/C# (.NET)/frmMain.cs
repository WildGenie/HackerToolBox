	...
	public class frmMain : System.Windows.Forms.Form
	{
        ...
        private void btnGenerate_Click(object sender, System.EventArgs e)
        {
            ...
            switch (kg.KeyMode)
            {
                ...
                case Enigma_KeyGen_IDE.RM_1024:
                    {
                ...
                case Enigma_KeyGen_IDE.RM_2048:
                    {
                ...
                case Enigma_KeyGen_IDE.RM_3072:
                    {
                ...
                case Enigma_KeyGen_IDE.RM_4096:
                    {
            ...
            kg.EncryptedSections = new byte[Enigma_KeyGen_IDE.NUMBER_OF_CRYPTED_SECTIONS];
        ...
        private void btnGenerateFP_Click(object sender, EventArgs e)
        {
            ...
            uint dwResult = Enigma_KeyGen_IDE.KG_GenerateRegistrationKeyFromProject("default.enigma", ref kg);
            if (dwResult == Enigma_KeyGen_IDE.EP_NO_ERROR)
            {
                tbKey.Text = kg.Key;
            }
        ...
        private void btnVerify_Click(object sender, EventArgs e)
        {
            ...
            Enigma_KeyGen_IDE.TKeyVerifyParams kv = new Enigma_KeyGen_IDE.TKeyVerifyParams();
            ...
            // Generate reg. key
            uint dwResult = Enigma_KeyGen_IDE.KG_VerifyRegistrationInfo(ref kv);
        ...
        private void btnVerifyFP_Click(object sender, EventArgs e)
        {
            ...
            // Generate reg. key
            uint dwResult = Enigma_KeyGen_IDE.KG_VerifyRegistrationInfoFromProject("default.enigma", ref kv);
