...
#ifdef _WIN64
	#pragma comment(lib, "enigma_ide64.lib")
#else
...
// Markers API
__declspec(dllimport) void __stdcall EP_Marker(char* Name);

// Registration API
__declspec(dllimport) BOOL __stdcall EP_RegSaveKey( char* Name, char* Key );
__declspec(dllimport) BOOL __stdcall EP_RegSaveKeyA( char* Name, char* Key );
__declspec(dllimport) BOOL __stdcall EP_RegSaveKeyW( wchar_t* Name, wchar_t* Key );
__declspec(dllimport) BOOL __stdcall EP_RegLoadKey( char** Name, char** Key );
__declspec(dllimport) BOOL __stdcall EP_RegLoadKeyA( char** Name, char** Key );
__declspec(dllimport) BOOL __stdcall EP_RegLoadKeyW( wchar_t** Name, wchar_t** Key );
__declspec(dllimport) BOOL __stdcall EP_RegCheckKey( char* Name, char* Key );
__declspec(dllimport) BOOL __stdcall EP_RegCheckKeyA( char* Name, char* Key );
__declspec(dllimport) BOOL __stdcall EP_RegCheckKeyW( wchar_t* Name, wchar_t* Key );
__declspec(dllimport) BOOL __stdcall EP_RegDeleteKey();
__declspec(dllimport) BOOL __stdcall EP_RegLoadAndCheckKey();
__declspec(dllimport) BOOL __stdcall EP_RegCheckAndSaveKey( char* Name, char* Key );
__declspec(dllimport) BOOL __stdcall EP_RegCheckAndSaveKeyA( char* Name, char* Key );
__declspec(dllimport) BOOL __stdcall EP_RegCheckAndSaveKeyW( wchar_t* Name, wchar_t* Key );
__declspec(dllimport) LPCTSTR __stdcall EP_RegHardwareID();
__declspec(dllimport) LPCTSTR __stdcall EP_RegHardwareIDA();
__declspec(dllimport) LPCWSTR __stdcall EP_RegHardwareIDW();
__declspec(dllimport) BOOL __stdcall EP_RegKeyCreationDate( int* Year, int* Month, int* Day );
__declspec(dllimport) BOOL __stdcall EP_RegKeyExpirationDate( int* Year, int* Month, int* Day );
__declspec(dllimport) int __stdcall EP_RegKeyCreationDateEx();
__declspec(dllimport) int __stdcall EP_RegKeyExpirationDateEx();
__declspec(dllimport) BOOL __stdcall EP_RegKeyExecutions( int* Total, int* Left );
__declspec(dllimport) int __stdcall EP_RegKeyExecutionsTotal();
__declspec(dllimport) int __stdcall EP_RegKeyExecutionsLeft();
__declspec(dllimport) BOOL __stdcall EP_RegKeyDays( int* Total, int* Left );
__declspec(dllimport) int __stdcall EP_RegKeyDaysTotal();
__declspec(dllimport) int __stdcall EP_RegKeyDaysLeft();
__declspec(dllimport) BOOL __stdcall EP_RegKeyRuntime( int* Total, int* Left );
__declspec(dllimport) int __stdcall EP_RegKeyRuntimeTotal();
__declspec(dllimport) int __stdcall EP_RegKeyRuntimeLeft();
__declspec(dllimport) BOOL __stdcall EP_RegKeyGlobalTime( int* Total, int* Left );
__declspec(dllimport) int __stdcall EP_RegKeyGlobalTimeTotal();
__declspec(dllimport) int __stdcall EP_RegKeyGlobalTimeLeft();
__declspec(dllimport) BOOL __stdcall EP_RegKeyRegisterAfterDate( int* Year, int* Month, int* Day );
__declspec(dllimport) int __stdcall EP_RegKeyRegisterAfterDateEx();
__declspec(dllimport) BOOL __stdcall EP_RegKeyRegisterBeforeDate( int* Year, int* Month, int* Day );
__declspec(dllimport) int __stdcall EP_RegKeyRegisterBeforeDateEx();
__declspec( dllexport ) BOOL __stdcall EP_RegKeyInformation(char* AName, char* AKey, PKeyInformation AKeyInfo);
__declspec( dllexport ) BOOL __stdcall EP_RegKeyInformationA(char* AName, char* AKey, PKeyInformation AKeyInfo);
__declspec( dllexport ) BOOL __stdcall EP_RegKeyInformationW(wchar_t* AName, wchar_t* AKey, PKeyInformation AKeyInfo);
__declspec(dllimport) int __stdcall EP_RegKeyStatus();
__declspec(dllimport) void __stdcall EP_RegShowDialog();

// Trial API
__declspec(dllimport) BOOL __stdcall EP_TrialExecutions( int* Total, int* Left );
__declspec(dllimport) int __stdcall EP_TrialExecutionsTotal();
__declspec(dllimport) int __stdcall EP_TrialExecutionsLeft();
__declspec(dllimport) BOOL __stdcall EP_TrialDays( int* Total, int* Left );
__declspec(dllimport) int __stdcall EP_TrialDaysTotal();
__declspec(dllimport) int __stdcall EP_TrialDaysLeft();
__declspec(dllimport) BOOL __stdcall EP_TrialExpirationDate( int* Year, int* Month, int* Day );
__declspec(dllimport) int __stdcall EP_TrialExpirationDateEx();
__declspec(dllimport) BOOL __stdcall EP_TrialDateTillDate( int* StartYear, int* StartMonth, int* StartDay, int* EndYear, int* EndMonth, int* EndDay );
__declspec(dllimport) int __stdcall EP_TrialDateTillDateStartEx();
__declspec(dllimport) int __stdcall EP_TrialDateTillDateEndEx();
__declspec(dllimport) BOOL __stdcall EP_TrialExecutionTime( int* Total, int* Left );
__declspec(dllimport) int __stdcall EP_TrialExecutionTimeTotal();
__declspec(dllimport) int __stdcall EP_TrialExecutionTimeLeft();
// Misc API
__declspec(dllimport) int __stdcall EP_MiscGetWatermark( int ID, PWMContent WM );
__declspec(dllimport) int __stdcall EP_MiscCountryCode();
// Protection API
__declspec(dllimport) int __stdcall EP_ProtectedStringByID( int ID, char* Str, int Len);
__declspec(dllimport) int __stdcall EP_ProtectedStringByKey( char* Key, char* Str, int Len);
// Crypt API
__declspec(dllimport) int __stdcall EP_CryptHashBuffer( int Hash, BYTE* Buffer, int Size, BYTE* Digest);
__declspec(dllimport) int __stdcall EP_CryptHashFileA( int Hash, char* FileName, BYTE* Digest);
__declspec(dllimport) int __stdcall EP_CryptHashFileW( int Hash, wchar_t* FileName, BYTE* Digest);
__declspec(dllimport) int __stdcall EP_CryptHashStringA( int Hash, char* Str, BYTE* Digest);
__declspec(dllimport) int __stdcall EP_CryptHashStringW( int Hash, wchar_t* Str, BYTE* Digest);
__declspec(dllimport) void __stdcall EP_CryptEncryptBuffer( BYTE* Buffer, int Size, char* Key);
__declspec(dllimport) void __stdcall EP_CryptEncryptBufferEx( BYTE* InBuffer, BYTE* OutBuffer, int Size, BYTE* Key, int KeySize);
__declspec(dllimport) void __stdcall EP_CryptDecryptBuffer( BYTE* Buffer, int Size, char* Key);
__declspec(dllimport) void __stdcall EP_CryptDecryptBufferEx( BYTE* InBuffer, BYTE* OutBuffer, int Size, BYTE* Key, int KeySize);
// Checkup API
__declspec(dllimport) BOOL __stdcall EP_CheckupCopies( int* Total, int* Current);
__declspec(dllimport) int __stdcall EP_CheckupCopiesTotal();
__declspec(dllimport) int __stdcall EP_CheckupCopiesCurrent();
__declspec(dllimport) BOOL __stdcall EP_CheckupIsProtected();
__declspec(dllimport) BOOL __stdcall EP_CheckupIsEnigmaOk();
__declspec(dllimport) BOOL __stdcall EP_CheckupVirtualizationTools();
// Enigma API
__declspec(dllimport) int __stdcall EP_EnigmaVersion();
// Splash screen
__declspec(dllimport) int __stdcall EP_SplashScreenShow();
__declspec(dllimport) void __stdcall EP_SplashScreenHide();
