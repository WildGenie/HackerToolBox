...
__declspec(dllimport) int __stdcall KG_GenerateRegistrationKey(PKeyGenParams kg);
__declspec(dllimport) int __stdcall KG_GenerateRegistrationKeyA(PKeyGenParamsA kg);
__declspec(dllimport) int __stdcall KG_GenerateRegistrationKeyW(PKeyGenParamsW kg);
__declspec(dllimport) int __stdcall KG_GenerateRegistrationKeyFromProject(char* pfile, PKeyGenParams kg);
__declspec(dllimport) int __stdcall KG_GenerateRegistrationKeyFromProjectA(char* pfile, PKeyGenParamsA kg);
__declspec(dllimport) int __stdcall KG_GenerateRegistrationKeyFromProjectW(wchar_t* pfile, PKeyGenParamsW kg);
__declspec(dllimport) int __stdcall KG_VerifyRegistrationInfo(PKeyVerifyParams kv);
__declspec(dllimport) int __stdcall KG_VerifyRegistrationInfoA(PKeyVerifyParamsA kv);
__declspec(dllimport) int __stdcall KG_VerifyRegistrationInfoW(PKeyVerifyParamsW kv);
__declspec(dllimport) int __stdcall KG_VerifyRegistrationInfoFromProject(char* pfile, PKeyVerifyParams kv);
__declspec(dllimport) int __stdcall KG_VerifyRegistrationInfoFromProjectA(char* pfile, PKeyVerifyParamsA kv);
__declspec(dllimport) int __stdcall KG_VerifyRegistrationInfoFromProjectW(wchar_t* pfile, PKeyVerifyParamsW kv);
