...
// Protection API
int __declspec(dllimport) __stdcall EP_ProtectedStringByID( int ID, char* Str, int Len);
int __declspec(dllimport) __stdcall EP_ProtectedStringByKey( char* Key, char* Str, int Len);
// Crypt API
