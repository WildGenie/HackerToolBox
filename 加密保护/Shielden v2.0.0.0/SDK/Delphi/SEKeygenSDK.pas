...
function SEAddKeyToDBA(pKeyPath: PAnsiChar): LongBool; stdcall; external SEKeygenDLL name 'SEAddKeyToDBA';
function SEAddKeyToDBW(pKeyPath: PWideChar): LongBool; stdcall; external SEKeygenDLL name 'SEAddKeyToDBW';
