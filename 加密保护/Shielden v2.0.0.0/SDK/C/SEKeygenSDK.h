...
extern "C" {
	...
	__declspec(dllimport) BOOL WINAPI SEAddKeyToDBA(char* pKeyPath);
	__declspec(dllimport) BOOL WINAPI SEAddKeyToDBW(wchar_t* pKeyPath);
...
#define SEAddKeyToDB SEAddKeyToDBW
#else
...
#define SEAddKeyToDB SEAddKeyToDBA
#endif
#endif