...
#define KEY_OK		    	0       //Successfully registered
#define KEY_INVALID	  	1       //Invalid serial number
#define KEY_TRAIL		    2       //Limited Key
#define KEY_OUTOFTICK  	3       //Exceed execution times that limited by Key
#define KEY_OUTOFDAYS   4       //Exceed trial days that limited by Key
#define KEY_OUTOFDATE 	5       //Software trial date expires, which is limited by Key
#define KEY_INVALIDDATE	6       //Key expires
#define KEY_BLOCKED		  7       //Blocked Key (key in blacklist)
...
int		__stdcall ZP_RegByKeyStr(char* pKeyStr,char* plpRegName = NULL);
int		__stdcall ZP_RegByKeyFile(char* pKeyFilePath);
BOOL	__stdcall ZP_RegShowRegWndProc(void* plpProc);
int		__stdcall ZP_ShowRegWindow();
...
char*	__stdcall ZP_GetGlobalString();
