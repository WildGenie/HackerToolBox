...
const int wlLicenseDisabledInInstance	= 15;
...
// ***********************************************
 ...
 extern "C" _stdcall __declspec(dllimport) bool WLRegNormalKeyCheckW(wchar_t* AsciiKey);

 extern "C" _stdcall __declspec(dllimport) bool WLRegNormalKeyInstallToFile(char* AsciiKey);

 extern "C" _stdcall __declspec(dllimport) bool WLRegNormalKeyInstallToFileW(wchar_t* AsciiKey);

 extern "C" _stdcall __declspec(dllimport) bool WLRegNormalKeyInstallToRegistry(char* AsciiKey);

 extern "C" _stdcall __declspec(dllimport) bool WLRegNormalKeyInstallToRegistryW(wchar_t* AsciiKey);
...
// (CURRENTLY DISABLED) extern "C" _stdcall __declspec(dllimport) bool WLRegGetLicenseHardwareID(char* pHardwareId);
 ...
 extern "C" bool _stdcall WLRegNormalKeyCheckW(wchar_t* AsciiKey);

 extern "C" bool _stdcall WLRegNormalKeyInstallToFile(char* AsciiKey);

 extern "C" bool _stdcall WLRegNormalKeyInstallToFileW(wchar_t* AsciiKey);

 extern "C" bool _stdcall WLRegNormalKeyInstallToRegistry(char* AsciiKey);

 extern "C" bool _stdcall WLRegNormalKeyInstallToRegistryW(wchar_t* AsciiKey);
