...
namespace WindowsApplication1
{
	...
	public class Form1 : System.Windows.Forms.Form
	{
        ...
        private void GenerateFileButton_Click(object sender, System.EventArgs e)
        {
            ...
            SizeKey = WinlicenseSDK.WLGenLicenseFileKeyExW(LicenseHash, pNameEdit, pOrgEdit, pCustomEdit, pHardIdEdit, LicenseFeatures, LicenseKeyBuff);
        ...
        private void GenerateTextButton_Click(object sender, System.EventArgs e)
        {
            ...
            SizeKey = WinlicenseSDK.WLGenLicenseTextKeyExW(LicenseHash, pNameEdit, pOrgEdit, pCustomEdit, pHardIdEdit, LicenseFeatures, LicenseKeyBuff);
        ...
        private void GenerateSmartButton_Click(object sender, System.EventArgs e)
        {
            ...
            SizeKey = WinlicenseSDK.WLGenLicenseDynSmartKeyW(LicenseHash, pNameEdit, pOrgEdit, pCustomEdit, pHardIdEdit, LicenseFeatures, LicenseKeyBuff);
        ...
        private void GenerateRegButton_Click(object sender, System.EventArgs e)
        {
            ...
            SizeKey = WinlicenseSDK.WLGenLicenseRegistryKeyExW(LicenseHash, pNameEdit, pOrgEdit, pCustomEdit, pHardIdEdit, LicenseFeatures, RegName, this.RegValueNameEdit.Text, LicenseKeyBuff);
    ...
    class WinlicenseSDK
    {
        ...
        public static extern int WLGenLicenseRegistryKeyExW(string LicenseHash, string UserName, string Organization, string CustomData, string MachineID,
            sLicenseFeatures LicenseFeatures, string RegName, string RegValueName, byte[] LicenseBuffer);
