...
namespace WindowsApplication1
{
	...
	public class Form1 : System.Windows.Forms.Form
	{
        ...
        private void GenerateFileButton_Click(object sender, System.EventArgs e)
        {
            ...
            if (this.ExpDateEnabledCheck.Checked == false)
            {
                SizeKey = WinlicenseSDK.WLGenLicenseFileKey(LicenseHash, pNameEdit, pOrgEdit, pCustomEdit, pHardIdEdit, mNumDays, mNumExec, NullExpDateSysTime, 0, 0, 0, LicenseKeyBuff);
            }
            else
            {
                SizeKey = WinlicenseSDK.WLGenLicenseFileKey(LicenseHash, pNameEdit, pOrgEdit, pCustomEdit, pHardIdEdit, mNumDays, mNumExec, ExpDateSysTime, 0, 0, 0, LicenseKeyBuff);
            }
        ...
        private void GenerateTextButton_Click(object sender, System.EventArgs e)
        {
            ...
            if (this.ExpDateEnabledCheck.Checked == false)
            {
                SizeKey = WinlicenseSDK.WLGenLicenseTextKey(LicenseHash, pNameEdit, pOrgEdit, pCustomEdit, pHardIdEdit, mNumDays, mNumExec, NullExpDateSysTime, 0, 0, 0, LicenseKeyBuff);
            }
            else
            {
                SizeKey = WinlicenseSDK.WLGenLicenseTextKey(LicenseHash, pNameEdit, pOrgEdit, pCustomEdit, pHardIdEdit, mNumDays, mNumExec, ExpDateSysTime, 0, 0, 0, LicenseKeyBuff);
            }
