...
Module Module1
    ...
    Public Declare Unicode Function WLGenLicenseDynSmartKeyW Lib "WinlicenseSDK.dll" (ByVal LicenseHash As String, ByVal UserName As String, ByVal Organization As String, ByVal CustomData As String, ByVal MachineID As String, ByRef LicenseFeatures As sLicenseFeatures, ByVal BufferOut As StringBuilder) As Integer
    ...
    Public Declare Unicode Function WLGenLicenseRegistryKeyExW Lib "WinlicenseSDK.dll" (ByVal LicenseHash As String, ByVal UserName As String, ByVal Organization As String, ByVal CustomData As String, ByVal MachineID As String, ByRef LicenseFeatures As sLicenseFeatures, ByVal RegKeyName As String, ByVal RegKeyValueName As String, ByVal BufferOut As Byte()) As Integer
